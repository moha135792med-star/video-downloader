...
# قالب صفحة التحميل المباشر مدمج فيه إعلانات Adsterra
DOWNLOAD_PAGE_HTML = """
<!DOCTYPE html>
...
<head>
    ...
    <style>
        body { font-family: 'Segoe UI', Tahoma, sans-serif; background-color: #f4f7f6; display: flex; justify-content: center; align-items: center; min-height: 100vh; margin: 0; padding: 20px; box-sizing: border-box; }
...
<body>
    <div class="card">
        ...
        <!-- إعلان Native Banner داخل الصفحة مكان كلمة مساحة إعلانية -->
        <div class="ad-container">
            <script async="async" data-cfasync="false" src="https://pl31362431.profitableratecpmnetwork.com/045ac0b88c3f0fa5a0ab6a4887d5a1ef/invoke.js"></script>
            <div id="container-045ac0b88c3f0fa5a0ab6a4887d5a1ef"></div>
        </div>
    ...
    <!-- إعلان Social Bar الخاص بصفحة التحميل -->
    <script src="https://pl31362432.profitableratecpmnetwork.com/f1/b2/56/f1b256f4dca874e577ac811ac90e7caf.js"></script>
...
def home():
    if os.path.exists('index.html'):
        with open('index.html', 'r', encoding='utf-8') as f:
            return f.read()
    return "مرحباً بك! ملف index.html غير موجود.", 404
...
def get_video_info():
    ...
    try:
        ...
        return jsonify({'error': f'تعذر معالجة الرابط: {str(e)}'}), 500

@app.route('/download-page', methods=['GET'])
def download_page():
    video_url = request.args.get('url')
    type_type = request.args.get('type')
    download_url = f"/process-download?url={video_url}&type={type_type}"
